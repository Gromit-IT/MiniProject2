...
<form name="myForm" action="/shop/orderComplete" method="post">
	<div class="container">
		...
		<div>
			<table class="table">
				...
				<tbody>
					<tr>
						<td>${cDTO.num}</td>
						<td><img src="images/items/${cDTO.goodsList[0].gImage}.gif"
		...
		<div class="row mb-3">
			...
			<div class="col-auto">
				<input type="text" class="form-control" name="username" id="mname"
					value="${mDTO.username}">
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-auto">
				<input type="text" name="post" class="form-control"
					value="${mDTO.post}" id="mpost" placeholder="우편번호">
			</div>
		</div>
		<div class="row mb-3">
			...
			<div class="col-sm-5">
				<input type="text" name="addr1" class="form-control"
					value="${mDTO.addr1}" id="maddress1" placeholder="도로명주소">
			</div>
		</div>
		<div class="row mb-3">
			...
			<div class="col-sm-5">
				<input type="text" name="addr2" class="form-control"
					value="${mDTO.addr2}" id="maddress2" placeholder="지번주소"> <span
		...
		<div class="row mb-3">
			...
			<div class="col-auto">
				<input type="text" name="phone" class="form-control" id="mphone"
					value="${mDTO.phone1}${mDTO.phone2}${mDTO.phone3}">
			</div>
		</div>
	</div>
	<hr>
